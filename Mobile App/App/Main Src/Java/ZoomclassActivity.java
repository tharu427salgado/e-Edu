...
public class ZoomclassActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.zoomclass);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				map.put("Nextclassdate", edittext1.getText().toString());
				map.put("Lesson", edittext2.getText().toString());
				map.put("Link", edittext3.getText().toString());
				Zoom.push().updateChildren(map);
